...
static void draw_level(lv_obj_t *canvas, const struct status_state *state) {
    ...
    lv_canvas_draw_text(canvas, 26, 0, 42, &label_right_dsc, "87%");
}
...
static void draw_charging_level(lv_obj_t *canvas, const struct status_state *state) {
    ...
    lv_canvas_draw_text(canvas, 26, 0, 35, &label_right_dsc, "94%");
...
void draw_battery_status(lv_obj_t *canvas, const struct status_state *state) {
    ...
    lv_canvas_draw_text(canvas, 0, 0, 25, &label_left_dsc, "MST");
    lv_canvas_draw_text(canvas, 0, 19, 25, &label_left_dsc, "SLV");
