...
static void draw_level(lv_obj_t *canvas, const struct status_state *state) {
    ...
    sprintf(text, "%i%%", state->battery);
    lv_canvas_draw_text(canvas, 26, 0, 42, &label_right_dsc, text);
    lv_canvas_draw_text(canvas, 26, 19, 42, &label_right_dsc, "77%");
}
...
static void draw_charging_level(lv_obj_t *canvas, const struct status_state *state) {
    ...
    sprintf(text, "%i%%", state->battery);
    lv_canvas_draw_text(canvas, 26, 0, 35, &label_right_dsc, text);
    lv_canvas_draw_img(canvas, 62, 2, &bolt, &img_dsc);
    
    lv_canvas_draw_text(canvas, 26, 19, 35, &label_right_dsc, "90%");
